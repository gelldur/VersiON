...
def bump_version(version, importance_of_change=1):
    '''
    ...
    try:
        return bump_semantic_version(version, importance_of_change)
    except:
        pass

    try:
        return bump_revision(version, importance_of_change)
    except:
        pass
...
def bump_semantic_version(version, importance_of_change=1):
...
def bump_revision(version, importance_of_change=1):
